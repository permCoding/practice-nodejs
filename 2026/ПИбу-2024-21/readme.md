...
- дождаться ответа, если всё нормально, то распечатать и сброшюровать в папку с мягкими обложками (первая прозрачная, последняя цветная)  
- `бумажную версию Отчёта принести в 306 ауд.` на Луне )))  
